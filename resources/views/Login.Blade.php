...
<html lang="en">
  ...
  <body class="d-flex">
    <form action="{{route('sign')}}" method="POST" class="form-login text-center">
        @csrf
        <h2>User login</h2>
        <input type="email" name="email" placeholder="Enter your Email Address" class="form-control mb-3" required>
          @error('email')
