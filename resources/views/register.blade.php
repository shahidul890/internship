  ...
  <body class="d-flex">
    <form action="{{ route('register') }}" method="POST" class="form-login text-center">
      ...
      <h2 class="font_weight">Hy! XYZ limited,</h2>
        ...
        <div class="row mb-3">
            <div class="col-md-5">
              <input type="text" name="fname" value="{{ old('fname') }}" placeholder="First Name" class="form-control text-left " >
              @error('fname')
        ...
        <div class="mb-3">
          <input type="email" placeholder="Email" name="email" value="{{ old('email') }}" class="form-control text-left" >
          @error('email')
            <span class="text-danger"> {{$message}}</span>
          @enderror
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="password" placeholder="Confirm Password" name="password_confirm" class="form-control mt-3" >
